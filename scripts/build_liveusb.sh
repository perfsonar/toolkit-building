...
label linux
	...
	menu default
	kernel vmlinuz0
	append initrd=initrd0.img root=CDLABEL=$BUILD_SHORT rootfstype=auto rootdelay=10 liveimg ro xdriver=vesa nomodeset askmethod
label single
	menu label ^Single-User Mode
	kernel vmlinuz0
	append initrd=initrd0.img root=CDLABEL=$BUILD_SHORT rootfstype=auto rootdelay=10 liveimg ro single xdriver=vesa nomodeset askmethod
label install
	menu label ^Install
	kernel vmlinuz0
	append initrd=initrd0.img root=CDLABEL=$BUILD_SHORT rootfstype=auto rootdelay=10 liveimg liveinst ro xdriver=vesa nomodeset askmethod
label memtest
