...
I2_REPO_STAGING_RPM="http://software.internet2.edu/rpms/el6/x86_64/RPMS.main/Internet2-repo-staging-0.6-1.noarch.rpm"
...
setarch $ARCHITECTURE yum install -y --installroot=$CHROOT_DIR $EPEL_RELEASE_RPM $I2_REPO_RPM I2_REPO_STAGING_RPM
